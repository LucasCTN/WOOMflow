 ...
 * 
 */
public class WARCModule extends AbstractJavaModule {

	private WARCPeerModule peerModule = null;

	private WARCLifeCycleHandler lifeCycleHandler = null;
	
	private static WARCModule instance;

	public static WARCModule getInstance() {
		return instance;
	}

	@Override
	public WARCPeerModule getPeerModule() {
	 ...
	 */
	public WARCModule(IModuleContext moduleContext) {
		super(moduleContext);

		WARCModule.instance = this;

		this.lifeCycleHandler = new WARCLifeCycleHandler(this);
		this.peerModule = new WARCPeerModule(this, moduleContext.getPeerConfiguration());
	}
