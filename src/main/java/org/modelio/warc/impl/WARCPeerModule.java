...
import org.modelio.warc.api.IWARCPeerModule;
 ...
 *
 */
public class WARCPeerModule implements IWARCPeerModule {
    private WARCModule module;
	
    private IModuleAPIConfiguration peerConfiguration;
    
	public WARCPeerModule(WARCModule statModuleModule, IModuleAPIConfiguration peerConfiguration) {
		super();
